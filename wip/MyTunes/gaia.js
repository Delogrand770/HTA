...
var XDS = {
	Ini:function(enc){
		...
		if (xsave_vars.length == 0 || xall_vars.length == 0){
			XM.Alert('XDataSystem - Error','You have not defined the arrays <font color="red">xsave_vars</font> and <font color="red">xall_vars</font>',0);
		}
	},
	Save:function(it){
	...
	VarState:function(){
		...
		XM.Alert('XData System - Variable State',xtemp[2],0);
		alert(xtemp[2]);
	}
};
