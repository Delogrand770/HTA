...
var XU = {
	...
	CreateShortcut:function(it,it2,ico,des,scut){
		if (!XS.File(xshell.SpecialFolders('Desktop') + '\\' + it + '.lnk','exist')){
			...
			scut.WorkingDirectory = xshell.SpecialFolders('Desktop');
			scut.Save();
		}
	}
};
...
var XM = {
	Ini:function(color1,color2,color3){
		...
		document.body.innerHTML+='<table style="position:absolute;top:-10;left:-10;z-index:111;display:none;" cellpadding=0 cellspacing=0 id="xmsg"><tr><td class="xmsg_t_l"></td><td class="xmsg_t_c"></td><td class="xmsg_t_r"></td></tr><tr><td class="xmsg_bg_l"></td><td class="xmsg_bg_c_t" id="xmsgtitle" style="color:'+color1+';"></td><td class="xmsg_bg_r"></tr><tr><td class="xmsg_bg_l"></td><td class="xmsg_bg_c_b" id="xmsgbody" style="color:'+color2+';overflow-x:auto;"></td><td class="xmsg_bg_r"></td></tr><tr id="xmsgok"><td class="xmsg_bg_l"></td><td class="xmsg_bg_c_c" onclick="XM.Close()" onmouseover="XU.RollColor(\''+color1+'\');" onmouseout="XU.RollColor(\''+color2+'\');" style="color:'+color2+';">Accept</td><td class="xmsg_bg_r"></tr><tr><td class="xmsg_b_l"></td><td class="xmsg_b_c"></td><td class="xmsg_b_r"></td></tr></table>';
		xmsgen = 1;
	},
	Overlay:function(it){
		if (it==0){
