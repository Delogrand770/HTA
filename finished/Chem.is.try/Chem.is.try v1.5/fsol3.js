...
var xele_temp  = 0;
var xityp_temp = 0;
var fso_dd = new Array(new Array("Sun","Mon","Tue","Wed","Thur","Fri","Sat"),new Array("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"));
...
var XMessage = {
	Ini:function(color1,color2,color3){
		...
		document.body.innerHTML+="<span style='position:absolute;z-index:120;display:none;position:absolute;top:300;left:300;' id='xmsg'><div class='xblogbefore'></div><div class='xblog'><h3><span id='xmsgtitle' style='color:"+color1+";font-weight:bold;text-align:center;'></span></h3><p class='xheadertext'></p><p style='text-align:center;'><span id='xmsgbody' style='color:"+color2+";'></span></p><span class='xheadertext'></span><span style='width:100%;background-Color:transparent;cursor:hand;text-align:center;height:20;color:"+color2+";border:1 solid "+color2+";' onclick='XMessage.Close()' onmouseover='XUtil.RollBgColor(\""+color1+"\");' onmouseout='XUtil.RollBgColor(\"transparent\");' id='xmsgok'>Accept</span></div><div class='xblogafter'></div></span>";
		xmsgen = 1;
	},
	Overlay:function(it){
		if (it==0){
